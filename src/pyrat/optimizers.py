...
class RPROP(Optimizer):
    def __init__(self, input_size, output_size, learning_rate=None, 
        ...
        self.delta_w = np.full((input_size, output_size), 0.01)
        self.delta_b = np.full((1, output_size), 0.01)
        
        self.prev_grad_w = np.zeros((input_size, output_size))
        self.prev_grad_b = np.zeros((1, output_size))
